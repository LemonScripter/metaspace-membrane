...
PROOFS = [
    ...
    ("C-79: a confined process executes only what its .bio grants", "evidence/run_c79_exec_proof.py"),
    ...
    ("Both shells on one host are decided by the same core (C-73/O-34)", "evidence/run_powershell_proof.py"),
]
