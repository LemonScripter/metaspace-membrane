...
| The Tools card ships a plain-language "How do these tools work?" help modal in EN/HU/RO, explaining how to use the authenticity gate (`verify`) and the app membrane (`run`) — including why they take a program's entry file | [PROVEN] | `run_ui_proof` (F4-6) | Win (2026-07-14); Linux re-run pending |
